        ...
        // 3. Full backup
          ...
          if (Array.isArray(json)) {
            ...
            if (json.length > 0 && 'name' in json[0] && 'position' in json[0]) {
              ...
              throw new Error("Unrecognized JSON array format. Please import a standard Sicko's Draft Hub export file (files exported under the earlier ProspectEngine name still work).");
            }
          } else {
            ...
            <div className="p-6 flex-1 overflow-y-auto space-y-6">
              ...
              {dataHubTab === 'import' && (
                <div className="space-y-5">
                  <p className="text-xs text-slate-400 leading-relaxed">
                    Import or update standard JSON files previously exported from Sicko's Draft Hub (including older ProspectEngine exports). Choose the type of import operation you would like to run:
                  </p>
