...
import { Player, Team, BigBoardInfo } from '../types';
...
export default function PlayerProfileModal({
  ...
  // Spec 03 position-aware trait view mode ('pillars' vs 'position')
  ...
  // 5 Pillars trait change handler
  ...
  // Spec 03 Position-Aware sub-trait change handler
  const handlePositionTraitChange = (traitKey: string, value: number) => {
    ...
    // Create intermediate player state to roll up pillars
    const tempPlayer = {
      ...editedPlayer,
  ...
  // Apply computed position grade directly to overall grade
      ...
      <div className="relative w-full max-w-5xl bg-slate-950 border-2 border-slate-800 rounded-none shadow-none overflow-hidden flex flex-col my-8 max-h-[90vh]">
        ...
        <div className="flex-1 overflow-y-auto p-6 md:p-8 space-y-8">
          ...
          <div className="bg-slate-900/40 border border-slate-800/80 rounded-xl p-5 md:p-6 space-y-6">
            ...
            {/* Position Grade Rollup & Top/Bottom Summary Banner */}
